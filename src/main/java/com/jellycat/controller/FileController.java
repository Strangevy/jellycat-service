...
import com.jellycat.dto.FileDelReq;
...
public class FileController {
    ...
    @DeleteMapping("/del/and/link")
    public ResponseVo<String> delFileAndLink(@RequestBody FileDelReq req) {
        fileService.delFileAndLink(req.path());
